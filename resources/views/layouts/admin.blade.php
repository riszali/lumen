...
<body class="bg-gray-50 dark:bg-dark font-montserrat antialiased text-gray-900 dark:text-white overflow-hidden flex h-screen relative">
    ...
    <div class="fixed top-[-10%] left-[-10%] w-[40%] h-[50%] bg-emerald-400 dark:bg-volt rounded-full filter blur-[100px] opacity-20 dark:opacity-10 pointer-events-none z-0 transform translate-z-0 will-change-transform"></div>
    <div class="fixed bottom-[-10%] right-[-5%] w-[40%] h-[40%] bg-teal-400 dark:bg-[#00E5FF] rounded-full filter blur-[100px] opacity-20 dark:opacity-10 pointer-events-none z-0 transform translate-z-0 will-change-transform"></div>
    ...
    <aside id="sidebar" class="w-72 bg-white/80 dark:bg-white/[0.03] backdrop-blur-xl border-r border-gray-200 dark:border-white/10 flex flex-col z-20 h-full relative shadow-[8px_0_32px_0_rgba(0,0,0,0.05)] dark:shadow-[8px_0_32px_0_rgba(0,0,0,0.3)] transition-[width] duration-300 ease-in-out">
        ...
        <div class="h-24 flex items-center justify-center border-b border-gray-200 dark:border-white/10 px-4 relative">
            <a href="{{ route('admin.dashboard') }}" class="block transform hover:scale-105 transition-transform duration-300 w-full flex justify-center">
                <img id="logo-full" src="{{ asset('assets/logo/will-sport-fix-transparant-logo-white-LFQ3FxNE1UZhtkMe.webp') }}" alt="WILLSPORTS Logo" class="h-20 w-auto object-contain scale-150 invert dark:invert-0 drop-shadow-[0_0_15px_rgba(0,0,0,0.1)] dark:drop-shadow-[0_0_15px_rgba(255,255,255,0.15)]">
                <h1 id="logo-mini" class="hidden font-bebas text-6xl text-emerald-600 dark:text-volt tracking-widest drop-shadow-sm mt-2">W</h1>
            </a>
        </div>

        <!-- Navigation Links -->
        <!-- OPTIMASI: transition-all diganti transition-colors duration-200 agar efek hover cepat dan ringan -->
        <nav class="flex-1 overflow-y-auto overflow-x-hidden py-8 px-4 space-y-3">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3.5 rounded-full transition-colors duration-200 group {{ request()->routeIs('admin.dashboard') ? 'bg-emerald-50 dark:bg-volt/20 text-emerald-600 dark:text-volt border border-emerald-200 dark:border-volt/30 shadow-sm dark:shadow-[0_0_15px_rgba(204,255,0,0.15)]' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/10 hover:text-emerald-600 dark:hover:text-white border border-transparent hover:shadow-inner' }}">
        ...
        <div class="p-4 border-t border-gray-200 dark:border-white/10 space-y-3 overflow-hidden">
            ...
            <a href="{{ route('home') }}" target="_blank" class="flex items-center px-4 py-3.5 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/10 hover:text-emerald-600 dark:hover:text-white transition-colors duration-200 border border-transparent hover:shadow-inner" title="Storefront">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden relative z-10">
        ...
        <!-- Header -->
        <header class="h-24 bg-white/80 dark:bg-white/[0.03] backdrop-blur-xl border-b border-gray-200 dark:border-white/10 flex items-center justify-between px-6 sm:px-10 z-20 shadow-[0_8px_32px_0_rgba(0,0,0,0.05)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.1)]">
            <div class="flex items-center">
                <!-- Tombol Minimize Menu -->
                <button onclick="toggleSidebar()" class="mr-4 sm:mr-6 p-2 rounded-full text-gray-500 hover:bg-gray-100 hover:text-emerald-600 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-volt transition-colors duration-200 focus:outline-none">
