...
@section('title', 'Shipping & Returns | WILLSPORTS')
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 sm:p-12 shadow-[0_8px_32px_0_rgba(0,0,0,0.4)]">
                ...
                <div class="text-brand-warm/90 font-light leading-loose space-y-4">
                    <p>WILLSPORTS offers complimentary fully-insured shipping on all orders within Indonesia. Your order will be securely packaged in our signature secure athletic packaging to ensure safety during transit.</p>
                    <p><strong class="text-brand-cream font-medium">Delivery Times:</strong> In-stock items are typically delivered within 2-4 business days. Custom team apparel requires 3-4 weeks for manufacturing before shipping.</p>
                    <p class="text-sm text-brand-gray italic">An adult signature is required upon delivery for all WILLSPORTS packages.</p>
                </div>
            </div>
            ...
            <div class="bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 sm:p-12 shadow-[0_8px_32px_0_rgba(0,0,0,0.4)]">
                ...
                <div class="text-brand-warm/90 font-light leading-loose space-y-4">
                    <p>We want you to be completely satisfied with your gear. If for any reason you are not, WILLSPORTS accepts returns and exchanges within 14 days of delivery.</p>
                    <p>Articles must be returned in their original, unworn condition, accompanied by all original packaging, tags, and the original sales receipt.</p>
                    <p class="text-sm text-brand-olive">Please note that personalized jerseys or customized equipment cannot be returned or exchanged.</p>
