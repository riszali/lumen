    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-10 lg:gap-12 mb-10 lg:mb-12 text-left">
            ...
            <div class="col-span-2 lg:col-span-1 text-center lg:text-left">
                <a href="{{ route('home') }}" class="inline-block mb-4 lg:mb-6">
                    <img src="{{ asset('assets/logo/logo-lumen-white.png') }}" alt="LUMEN Logo" class="h-7 lg:h-8 object-contain mx-auto lg:mx-0 opacity-90 hover:opacity-100 transition">
                </a>
                <p class="text-brand-gray text-xs lg:text-sm font-light leading-relaxed max-w-xs mx-auto lg:mx-0">
                    Elegance in every detail. Crafted for eternity with ethically sourced materials and masterful artistry.
                </p>
            </div>
            ...
            <div class="col-span-1 flex flex-col space-y-3 text-sm text-brand-gray font-light px-2 sm:px-4 lg:px-0">
                ...
                <a href="{{ route('shop.index') }}" class="hover:text-brand-sage transition inline-block">All Collections</a>
                <a href="#" class="hover:text-brand-sage transition inline-block">New Arrivals</a>
                <a href="#" class="hover:text-brand-sage transition inline-block">Bespoke Jewelry</a>
            </div>
            ...
            <div class="col-span-2 lg:col-span-1 flex flex-col items-center lg:items-start pt-2 lg:pt-0">
                ...
                <div class="flex flex-row justify-center lg:justify-start gap-6 w-full text-brand-gray mt-2">
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/lu.men___/" target="_blank" class="hover:text-brand-sage transition hover:-translate-y-1 transform" aria-label="Instagram">
                    ...
                    <!-- TikTok -->
                    <a href="https://www.tiktok.com/@lu.men___?_r=1&_t=zs-94ddlztoahe" target="_blank" class="hover:text-brand-sage transition hover:-translate-y-1 transform" aria-label="TikTok">
                    ...
                    <!-- Tokopedia -->
                    <a href="https://www.tokopedia.com/lumen-7?utm_campaign=Shop-0-7494414021201593363-250226-contextual_image-semua_produk-LSfHao&utm_medium=share&utm_source=salinlink" target="_blank" class="hover:text-brand-sage transition hover:-translate-y-1 transform" aria-label="Tokopedia">
                    ...
                    <!-- Shopee -->
                    <a href="https://shopee.co.id/lu.men?entryPoint=ShopBySearch&searchKeyword=lu.men" target="_blank" class="hover:text-brand-sage transition hover:-translate-y-1 transform" aria-label="Shopee">
        ...
        <div class="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center text-[10px] sm:text-xs text-brand-olive font-light tracking-wider">
            <div class="flex flex-col items-center md:items-start gap-2">
                <p>&copy; {{ date('Y') }} LUMEN Fine Jewelry. All rights reserved.</p>
